...
namespace Robotango.Tests.Units.Abilities
{
    ...
    public class Thinking_Tests : BaseTests
    {
        ...
        public void Agent_believes_that_its_hat_is_red()
        {
            ...
            Assert.AreEqual( Colors.Red,
                agent.As< IThinking >().InnerReality.GetAgent( agent ).As< IVirtual >().GetAttribute< IHat >().Color );
        }
        ...
        public void Alice_thinks_a_lot()
        {
            ...
            Assert.AreEqual( Colors.Red,
                alice.As< IThinking >().InnerReality.GetAgent( alice ).As< IVirtual >().GetAttribute< IHat >().Color );
        }
        ...
        public void Alice_imaginates_Bob_which_imaginates_Alice()
        {
            ...
            alice.As< IThinking >()
                ...
                .As< IThinking >()
                .AddBelief( world => world.AddAgent( alice.Clone() ) );
